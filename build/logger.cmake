...
message(STATUS "LOG_LEVEL_INTERNAL=${LOG_LEVEL_INTERNAL}")
########################################################################
...
function(logInternal LEVEL MODE PATH  TXT)
    if (${${LEVEL}} LESS_EQUAL ${LOG_LEVEL_INTERNAL})
        ...
        message(STATUS "LEVEL=${LEVEL} (LEVEL2=${${LEVEL}}) vs LOG_LEVEL_INTERNAL=${LOG_LEVEL_INTERNAL}")
        message(STATUS "TXT=${TXT}")
    endif()
endfunction()
